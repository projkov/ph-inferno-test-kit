...
module PHCoreTestKit
  module PHCoreV020_CI_BUILD
    class PatientValidationTest < Inferno::Test
      ...
      id :ph_core_v020_ci_build_patient_validation_test
      title 'Patient resources returned during previous tests conform to the PH Core Patient'
      description %(
This test verifies resources returned from the first search conform to
the [PH Core Patient](https://fhir.doh.gov.ph/phcore/StructureDefinition/ph-core-patient).
