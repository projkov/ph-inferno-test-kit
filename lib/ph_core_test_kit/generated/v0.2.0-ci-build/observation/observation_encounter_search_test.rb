...
module PHCoreTestKit
  module PHCoreV020_CI_BUILD
    class ObservationEncounterSearchTest < Inferno::Test
      include InfernoSuiteGenerator::SearchTest

      title '(SHOULD) Server returns valid results for Observation search by encounter'
      description %(
A server SHOULD support searching by
encounter on the Observation resource. This test
...
[PH Core Server CapabilityStatement](https://fhir.doh.gov.ph/phcore/CapabilityStatement/ph-core-server)
      ...
      id :ph_core_v020_ci_build_observation_encounter_search_test
      optional
