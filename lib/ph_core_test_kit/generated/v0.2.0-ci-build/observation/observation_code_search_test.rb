...
module PHCoreTestKit
  module PHCoreV020_CI_BUILD
    class ObservationCodeSearchTest < Inferno::Test
      include InfernoSuiteGenerator::SearchTest

      title '(SHOULD) Server returns valid results for Observation search by code'
      description %(
...
[PH Core Server CapabilityStatement](https://fhir.doh.gov.ph/phcore/CapabilityStatement/ph-core-server)
      ...
      id :ph_core_v020_ci_build_observation_code_search_test
      optional
