...
module PHCoreTestKit
  module PHCoreV020_CI_BUILD
    class ObservationValidationTest < Inferno::Test
      ...
      id :ph_core_v020_ci_build_observation_validation_test
      title 'Observation resources returned during previous tests conform to the PH Core Observation'
      description %(
This test verifies resources returned from the first search conform to
the [PH Core Observation](https://fhir.doh.gov.ph/phcore/StructureDefinition/ph-core-observation).
