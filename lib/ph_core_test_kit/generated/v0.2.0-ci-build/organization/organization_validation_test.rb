...
module PHCoreTestKit
  module PHCoreV020_CI_BUILD
    class OrganizationValidationTest < Inferno::Test
      ...
      id :ph_core_v020_ci_build_organization_validation_test
      title 'Organization resources returned during previous tests conform to the PH Core Organization'
      description %(
This test verifies resources returned from the first search conform to
the [PH Core Organization](https://fhir.doh.gov.ph/phcore/StructureDefinition/ph-core-organization).
