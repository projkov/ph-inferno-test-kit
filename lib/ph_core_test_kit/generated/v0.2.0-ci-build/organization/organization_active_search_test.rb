...
module PHCoreTestKit
  module PHCoreV020_CI_BUILD
    class OrganizationActiveSearchTest < Inferno::Test
      include InfernoSuiteGenerator::SearchTest

      title '(MAY) Server returns valid results for Organization search by active'
      description %(
A server MAY support searching by
active on the Organization resource. This test
...
[PH Core Server CapabilityStatement](https://fhir.doh.gov.ph/phcore/CapabilityStatement/ph-core-server)
      ...
      id :ph_core_v020_ci_build_organization_active_search_test
      optional
