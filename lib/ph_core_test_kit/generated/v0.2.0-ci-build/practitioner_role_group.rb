...
module PHCoreTestKit
  module PHCoreV020_CI_BUILD
    class PractitionerRoleGroup < Inferno::TestGroup
      ...
      short_description 'Verify support for the server capabilities required by the PH Core PractitionerRole.'
      description %(
  # Background

The PH Core PractitionerRole sequence verifies that the system under test is
able to provide correct responses for PractitionerRole queries. These queries
must contain resources conforming to the PH Core PractitionerRole as
...
the [PH Core PractitionerRole](https://fhir.doh.gov.ph/phcore/StructureDefinition/ph-core-practitionerrole). Each element is checked against
...
read succeeds.
      ...
      id :ph_core_v020_ci_build_practitioner_role
      run_as_group
      ...
      test from: :ph_core_v020_ci_build_practitioner_role_read_test
      test from: :ph_core_v020_ci_build_practitioner_role__id_search_test
      test from: :ph_core_v020_ci_build_practitioner_role_practitioner_search_test
      test from: :ph_core_v020_ci_build_practitioner_role_organization_search_test
      test from: :ph_core_v020_ci_build_practitioner_role_specialty_search_test
      test from: :ph_core_v020_ci_build_practitioner_role_validation_test
      test from: :ph_core_v020_ci_build_practitioner_role_must_support_test
      test from: :ph_core_v020_ci_build_practitioner_role_reference_resolution_test
    end
  end
end
