...
module PHCoreTestKit
  module PHCoreV020_CI_BUILD
    class ConditionEncounterSearchTest < Inferno::Test
      include InfernoSuiteGenerator::SearchTest

      title '(SHOULD) Server returns valid results for Condition search by encounter'
      description %(
...
[PH Core Server CapabilityStatement](https://fhir.doh.gov.ph/phcore/CapabilityStatement/ph-core-server)
      ...
      id :ph_core_v020_ci_build_condition_encounter_search_test
      optional
