...
module PHCoreTestKit
  module PHCoreV020_CI_BUILD
    class ConditionValidationTest < Inferno::Test
      ...
      id :ph_core_v020_ci_build_condition_validation_test
      title 'Condition resources returned during previous tests conform to the PH Core Condition'
      description %(
This test verifies resources returned from the first search conform to
the [PH Core Condition](https://fhir.doh.gov.ph/phcore/StructureDefinition/ph-core-condition).
