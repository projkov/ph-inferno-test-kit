...
module PHCoreTestKit
  module PHCoreV020_CI_BUILD
    class EncounterGroup < Inferno::TestGroup
      ...
      short_description 'Verify support for the server capabilities required by the PH Core Encounter.'
      description %(
  # Background

The PH Core Encounter sequence verifies that the system under test is
able to provide correct responses for Encounter queries. These queries
must contain resources conforming to the PH Core Encounter as
...
the [PH Core Encounter](https://fhir.doh.gov.ph/phcore/StructureDefinition/ph-core-encounter). Each element is checked against
...
read succeeds.
      ...
      id :ph_core_v020_ci_build_encounter
      run_as_group
      ...
      test from: :ph_core_v020_ci_build_encounter_patient_search_test
      test from: :ph_core_v020_ci_build_encounter__id_search_test
      test from: :ph_core_v020_ci_build_encounter_status_search_test
      test from: :ph_core_v020_ci_build_encounter_class_search_test
      test from: :ph_core_v020_ci_build_encounter_date_search_test
      test from: :ph_core_v020_ci_build_encounter_read_test
      test from: :ph_core_v020_ci_build_encounter_validation_test
      test from: :ph_core_v020_ci_build_encounter_must_support_test
      test from: :ph_core_v020_ci_build_encounter_reference_resolution_test
    end
  end
end
