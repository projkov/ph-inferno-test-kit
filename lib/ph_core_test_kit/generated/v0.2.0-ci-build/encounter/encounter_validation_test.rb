...
module PHCoreTestKit
  module PHCoreV020_CI_BUILD
    class EncounterValidationTest < Inferno::Test
      ...
      id :ph_core_v020_ci_build_encounter_validation_test
      title 'Encounter resources returned during previous tests conform to the PH Core Encounter'
      description %(
This test verifies resources returned from the first search conform to
the [PH Core Encounter](https://fhir.doh.gov.ph/phcore/StructureDefinition/ph-core-encounter).
