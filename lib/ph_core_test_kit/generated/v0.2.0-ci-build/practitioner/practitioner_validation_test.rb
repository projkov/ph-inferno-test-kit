...
module PHCoreTestKit
  module PHCoreV020_CI_BUILD
    class PractitionerValidationTest < Inferno::Test
      ...
      id :ph_core_v020_ci_build_practitioner_validation_test
      title 'Practitioner resources returned during previous tests conform to the PH Core Practitioner'
      description %(
This test verifies resources returned from the first search conform to
the [PH Core Practitioner](https://fhir.doh.gov.ph/phcore/StructureDefinition/ph-core-practitioner).
