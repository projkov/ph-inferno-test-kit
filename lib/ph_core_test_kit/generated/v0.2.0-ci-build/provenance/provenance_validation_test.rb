...
module PHCoreTestKit
  module PHCoreV020_CI_BUILD
    class ProvenanceValidationTest < Inferno::Test
      ...
      id :ph_core_v020_ci_build_provenance_validation_test
      title 'Provenance resources returned during previous tests conform to the PH Core Provenance'
      description %(
This test verifies resources returned from the first search conform to
the [PH Core Provenance](https://fhir.doh.gov.ph/phcore/StructureDefinition/ph-core-provenance).
