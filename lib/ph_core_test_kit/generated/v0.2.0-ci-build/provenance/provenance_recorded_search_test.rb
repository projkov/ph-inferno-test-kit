...
module PHCoreTestKit
  module PHCoreV020_CI_BUILD
    class ProvenanceRecordedSearchTest < Inferno::Test
      include InfernoSuiteGenerator::SearchTest

      title '(SHOULD) Server returns valid results for Provenance search by recorded'
      description %(
A server SHOULD support searching by
recorded on the Provenance resource. This test
...
[PH Core Server CapabilityStatement](https://fhir.doh.gov.ph/phcore/CapabilityStatement/ph-core-server)
      ...
      id :ph_core_v020_ci_build_provenance_recorded_search_test
      optional
