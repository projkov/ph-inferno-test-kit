...
module PHCoreTestKit
  module PHCoreV020_CI_BUILD
    class ServiceRequestEncounterSearchTest < Inferno::Test
      include InfernoSuiteGenerator::SearchTest

      title '(SHOULD) Server returns valid results for ServiceRequest search by encounter'
      description %(
A server SHOULD support searching by
encounter on the ServiceRequest resource. This test
...
[PH Core Server CapabilityStatement](https://fhir.doh.gov.ph/phcore/CapabilityStatement/ph-core-server)
      ...
      id :ph_core_v020_ci_build_service_request_encounter_search_test
      optional
