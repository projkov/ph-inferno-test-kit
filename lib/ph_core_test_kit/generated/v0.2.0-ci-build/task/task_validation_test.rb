...
module PHCoreTestKit
  module PHCoreV020_CI_BUILD
    class TaskValidationTest < Inferno::Test
      ...
      id :ph_core_v020_ci_build_task_validation_test
      title 'Task resources returned during previous tests conform to the PH Core Task'
      description %(
This test verifies resources returned from the first search conform to
the [PH Core Task](https://fhir.doh.gov.ph/phcore/StructureDefinition/ph-core-task).
...
fail if their code/system are not found in the valueset.
      ...
      run do
        perform_validation_test(scratch_resources[:all] || [],
                                'https://fhir.doh.gov.ph/phcore/StructureDefinition/ph-core-task',
                                '0.2.0',
                                skip_if_empty: true)
      end
    end
