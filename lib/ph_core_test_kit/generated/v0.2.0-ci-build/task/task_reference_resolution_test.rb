...
module PHCoreTestKit
  module PHCoreV020_CI_BUILD
    class TaskReferenceResolutionTest < Inferno::Test
      include InfernoSuiteGenerator::ReferenceResolutionTest

      title 'MustSupport references within Task resources are valid'
      description %(
      ...
      id :ph_core_v020_ci_build_task_reference_resolution_test
