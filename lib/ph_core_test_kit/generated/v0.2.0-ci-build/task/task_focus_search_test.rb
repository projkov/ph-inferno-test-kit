...
module PHCoreTestKit
  module PHCoreV020_CI_BUILD
    class TaskFocusSearchTest < Inferno::Test
      include InfernoSuiteGenerator::SearchTest

      title '(SHOULD) Server returns valid results for Task search by focus'
      description %(
A server SHOULD support searching by
focus on the Task resource. This test
...
[PH Core Server CapabilityStatement](https://fhir.doh.gov.ph/phcore/CapabilityStatement/ph-core-server)
      ...
      id :ph_core_v020_ci_build_task_focus_search_test
      optional
