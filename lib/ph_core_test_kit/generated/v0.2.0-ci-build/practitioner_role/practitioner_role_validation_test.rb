...
module PHCoreTestKit
  module PHCoreV020_CI_BUILD
    class PractitionerRoleValidationTest < Inferno::Test
      ...
      id :ph_core_v020_ci_build_practitioner_role_validation_test
      title 'PractitionerRole resources returned during previous tests conform to the PH Core PractitionerRole'
      description %(
This test verifies resources returned from the first search conform to
the [PH Core PractitionerRole](https://fhir.doh.gov.ph/phcore/StructureDefinition/ph-core-practitionerrole).
