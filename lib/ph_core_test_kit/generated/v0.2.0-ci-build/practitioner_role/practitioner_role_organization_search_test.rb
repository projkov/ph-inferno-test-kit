...
module PHCoreTestKit
  module PHCoreV020_CI_BUILD
    class PractitionerRoleOrganizationSearchTest < Inferno::Test
      ...
      title '(SHOULD) Server returns valid results for PractitionerRole search by organization'
      description %(
...
[PH Core Server CapabilityStatement](https://fhir.doh.gov.ph/phcore/CapabilityStatement/ph-core-server)
      ...
      id :ph_core_v020_ci_build_practitioner_role_organization_search_test
      optional
