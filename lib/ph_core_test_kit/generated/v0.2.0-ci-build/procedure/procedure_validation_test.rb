...
module PHCoreTestKit
  module PHCoreV020_CI_BUILD
    class ProcedureValidationTest < Inferno::Test
      ...
      id :ph_core_v020_ci_build_procedure_validation_test
      title 'Procedure resources returned during previous tests conform to the PH Core Procedure'
      description %(
This test verifies resources returned from the first search conform to
the [PH Core Procedure](https://fhir.doh.gov.ph/phcore/StructureDefinition/ph-core-procedure).
